...
router.register('task',TaskViewset,basename='task1')
router.register('completed_task',views.CompletedTaskviewset,basename='task2')
router.register('due_task',views.DueTaskViewset,basename='task3')
